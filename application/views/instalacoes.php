                    ...
                    <div class="portlet light ">
                        <div class="portlet-title tabbable-line">
                            <div class="caption caption-md">
                                ...
                                <span class="caption-subject font-blue-madison bold uppercase">Vista Geral</span>
                            </div>
                            <ul class="nav nav-tabs">

                                <li class="active">
                                    <a href="#tab_1_2" data-toggle="tab">Instalações</a>
                                </li>
                        ...
                        <div class="portlet-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_1_2">
                                    ...
                                    <br><br>
                                    <table class="table table-striped table-bordered table-hover order-column" id="table_instalacoes">
                                        <thead>
                                            <tr>
                                                <th> Instalacao </th>
                                                <th> Morada </th>
                                                <th> Código Postal</th>
                                                <th> Distrito/Concelho </th>
                                                <th> Email </th>
                                                <th> Telefone </th>
                                                <th></th>
                                            </tr>
